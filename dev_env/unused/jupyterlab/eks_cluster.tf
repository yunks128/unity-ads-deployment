...
#data "tls_certificate" "jupyter_cluster_oidc_issuer" {
#  url = aws_eks_cluster.jupyter_cluster.identity[0].oidc[0].issuer
#}
#
#resource "aws_iam_openid_connect_provider" "jupyter_cluster_oidc" {
#  client_id_list  = ["sts.amazonaws.com"]
#  thumbprint_list = [data.tls_certificate.jupyter_cluster_oidc_issuer.certificates[0].sha1_fingerprint]
#  url             = data.tls_certificate.jupyter_cluster_oidc_issuer.url
#}
